...
from architecture import MemSeg, MemoryBank
...
if __name__=='__main__':
    ...
    parser.add_argument('--yaml_config', type=str, default='/media/niko/E/01.Self-training/MemSeg-Defect-Detection/configs/capsule.yaml', help='exp config file')    
