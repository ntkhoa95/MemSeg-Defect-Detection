...
def load_model(object_name):
    ...
    # model.load_state_dict(torch.load(f'./checkpoints/original/{object_name}/latest_model.pt'))
...
def inference(img: torch.Tensor, min_area=100):
    output = model(img.unsqueeze(0)).cpu().detach()
...
if __name__ == "__main__":
    ...
    model_list = 'MemSeg-Original-mobilepad'
    print("Loading model ...")
